...
outcsv_path = os.path.join(root_dir, "result\potential_integrated_csv")
...
sunlight_public = os.path.join(root_dir, "result\sunlight_public_csv\*.csv")
"""
====field名一覧====
=REPOS=
・onshore
...
df_merged_public["publicSun"] = df_merged_public["publicholl"] + df_merged_public["gym"] + df_merged_public["school"] + df_merged_public["univ"] + df_merged_public["sewerage"]
